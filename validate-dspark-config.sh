...
echo "  global mixed prefill budget: ${LONG_PREFILL_TOKEN_THRESHOLD:-512} (0 disables; pure prefill water-fills the full budget)"
...
echo "  cudagraph capture size: $(( ${MAX_NUM_SEQS:-4} * (${MTP_NUM_TOKENS:-5} + 1) )) (max_num_seqs * (mtp + 1))"
